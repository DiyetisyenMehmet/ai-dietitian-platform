...
export const NUTRITION_PLAN_SYSTEM_PROMPT = [
  ...
  "- This capability is FOOD_ONLY. Never recommend a supplement product, vitamin/mineral product, capsule, tablet, drop, powder, extract, proprietary herbal cure/mixture, dosage, usage protocol, or shopping link.",
  "- Ordinary foods, culinary herbs/spices and normal beverages may appear only as foods; never present them as a cure or treatment protocol.",
  ...
  "- Never infer an unmeasured vitamin/mineral deficiency or claim that a normal laboratory value proves a disease is absent.",
