...
const securityHeaders = [
  ...
  // Barcode scanning on the web/PWA needs camera access from this origin only.
  // Microphone and geolocation remain disabled. Android prefers its native ML
  // Kit scanner and therefore does not depend on this browser capability.
